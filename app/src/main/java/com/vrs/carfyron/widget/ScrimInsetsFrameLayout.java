package com.vrs.carfyron.widget;
...
/**
 * A layout that draws something in the insets passed to {@link #fitSystemWindows(android
 * .graphics.Rect)}, i.e. the area above UI chrome
